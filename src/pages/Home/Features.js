          ...
          <div className="row g-0">
            <div className="col-md-4 col-sm-12 text-center">
              ...
              <p className={classes.featureText}>
                A cutting-edge AMM with Multichain & Cross-Chain features, which
                redistributes earnings to pools and capitalizes on user
                slippages.
              </p>
            </div>
            ...
            <div className="col-md-4 col-sm-12 text-center">
              ...
              <p className={classes.featureText}>
                Earn 90% of transaction fees by providing liquidity to liquidity
                pools.
              </p>
            </div>
